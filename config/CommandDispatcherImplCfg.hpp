...
enum {
    CMD_DISPATCHER_DISPATCH_TABLE_SIZE = 11, // !< The size of the table holding opcodes to dispatch
    CMD_DISPATCHER_SEQUENCER_TABLE_SIZE = 1, // !< The size of the table holding commands in progress
};
